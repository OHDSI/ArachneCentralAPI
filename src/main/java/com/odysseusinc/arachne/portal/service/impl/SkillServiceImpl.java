...
public class SkillServiceImpl extends BaseSkillServiceImpl<Skill> implements SkillService {

    @Autowired
    protected SkillServiceImpl(SkillRepository<Skill> skillRepository) {
