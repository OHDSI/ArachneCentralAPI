...
@Service
@Transactional
public class SubmissionInvalidateServiceImpl extends BaseSubmissionInvalidateServiceImpl<Submission, Analysis>
        implements SubmissionInvalidateService {

    public SubmissionInvalidateServiceImpl(SubmissionRepository submissionRepository,
                                           BaseAnalysisService<Analysis> analysisService,
                                           SubmissionService submissionService) {

        super(submissionRepository, analysisService, submissionService);
    }
