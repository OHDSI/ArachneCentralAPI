...
public interface RawUserService {
    ...
    RawUser getById(Long id);

    RawUser findLoginCandidate(String userOrigin, String username);

    RawUser findLoginCandidate(String username);

    RawUser update(RawUser user) throws IOException, NoSuchFieldException, SolrServerException, IllegalAccessException;

    void indexBySolr(RawUser user)
