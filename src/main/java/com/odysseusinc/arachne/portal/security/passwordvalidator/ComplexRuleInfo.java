...
public class ComplexRuleInfo extends RuleInfo {

    protected Set<RuleInfo> rules;

    protected ComplexRuleInfo(String description, Set<RuleInfo> rules) {

        super(description);
        this.rules = rules;
    }

    public Set<RuleInfo> getRules() {
