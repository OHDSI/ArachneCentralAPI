...
public class ArachnePasswordValidationResult {
    private boolean valid;
    private final List<ArachneRuleResult> results = new ArrayList<>();


    public ArachnePasswordValidationResult() {

    }

    public ArachnePasswordValidationResult(boolean valid) {
    ...
    public void addResult(ArachneRuleResult result) {
