...
public abstract class BaseUserToUserWithTenantsDTOConverter<DTO extends UserWithTenantsDTO> extends BaseUserToCommonUserDTOConverter<DTO> {

    @Override
    public DTO convert(final IUser user) {

        final DTO dto = super.convert(user);
