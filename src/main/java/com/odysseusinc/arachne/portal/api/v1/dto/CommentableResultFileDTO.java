...
public class CommentableResultFileDTO extends ResultFileDTO implements Commentable {
    ...
    public Commentable clone() {
        ...
        final CommentableResultFileDTO clone = new CommentableResultFileDTO();
        clone.setCommentTopicId(commentTopicId);
        clone.setTopic(topic);
        clone.setCommentCount(commentCount);
        clone.setSubmissionId(submissionId);
        clone.setUuid(uuid);
        clone.setName(name);
