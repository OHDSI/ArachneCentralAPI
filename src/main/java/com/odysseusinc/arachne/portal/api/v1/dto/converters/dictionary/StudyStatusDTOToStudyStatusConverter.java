...
@Component
public class StudyStatusDTOToStudyStatusConverter extends BaseConversionServiceAwareConverter<StudyStatusDTO, StudyStatus> {


    @Override
    public StudyStatus convert(StudyStatusDTO source) {
