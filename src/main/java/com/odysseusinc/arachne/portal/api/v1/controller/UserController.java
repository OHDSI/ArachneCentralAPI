...
public class UserController extends BaseUserController<BaseUser, RawUser, User, Study, DataSource, StudySearch, StudyViewItem, DataNode, Paper, PaperSearch, Skill, Analysis, Submission> {
