-- Recreates view with original definition just to update "users" reference -
-- due to error in ordering of statements in original migration, it still holds "users_data"
